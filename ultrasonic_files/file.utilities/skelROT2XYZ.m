function [skXYZ] = skelROT2XYZ(skROT,limbLengths)
% Thomas S. Murray
% 2014/11/11
%
% Input:
...
%   skXYZ - 3D skeleton in cartesian coordinates [numJoints x 3]
  ...
  skROT_aug = [skROT(2:end,1) skROT(2:end,2) zeros(19,1) skROT(2:end,3)];
  ...
  skXYZ( 8,:) = skXYZ( 7,:) + (limbLengths( 7)*[0 0 1]*vrrotvec2mat(skROT_aug( 7,:))); % left hand
  skXYZ( 9,:) = skXYZ( 3,:) + (limbLengths( 8)*[0 0 1]*vrrotvec2mat(skROT_aug( 8,:))); % right shoulder
  skXYZ(10,:) = skXYZ( 9,:) + (limbLengths( 9)*[0 0 1]*vrrotvec2mat(skROT_aug( 9,:))); % right elbow
  skXYZ(11,:) = skXYZ(10,:) + (limbLengths(10)*[0 0 1]*vrrotvec2mat(skROT_aug(10,:))); % right wrist
  skXYZ(12,:) = skXYZ(11,:) + (limbLengths(11)*[0 0 1]*vrrotvec2mat(skROT_aug(11,:))); % right hand
  skXYZ(13,:) = skXYZ( 1,:) + (limbLengths(12)*[0 0 1]*vrrotvec2mat(skROT_aug(12,:))); % left hip
  skXYZ(14,:) = skXYZ(13,:) + (limbLengths(13)*[0 0 1]*vrrotvec2mat(skROT_aug(13,:))); % left knee
  skXYZ(15,:) = skXYZ(14,:) + (limbLengths(14)*[0 0 1]*vrrotvec2mat(skROT_aug(14,:))); % left ankle
  skXYZ(16,:) = skXYZ(15,:) + (limbLengths(15)*[0 0 1]*vrrotvec2mat(skROT_aug(15,:))); % left foot
  skXYZ(17,:) = skXYZ( 1,:) + (limbLengths(16)*[0 0 1]*vrrotvec2mat(skROT_aug(16,:))); % right hip
  skXYZ(18,:) = skXYZ(17,:) + (limbLengths(17)*[0 0 1]*vrrotvec2mat(skROT_aug(17,:))); % right knee
  skXYZ(19,:) = skXYZ(18,:) + (limbLengths(18)*[0 0 1]*vrrotvec2mat(skROT_aug(18,:))); % right ankle
  skXYZ(20,:) = skXYZ(19,:) + (limbLengths(19)*[0 0 1]*vrrotvec2mat(skROT_aug(19,:))); % right foot
return;
